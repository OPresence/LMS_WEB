...
export default function TermsAndCondition() {
  return (
    <div className="terms__container">
      ...
      <h6>
        These Terms of Use set out the terms and conditions for use of this The
        Financial Ladder ( “Website”) and any content, Public Forums, or
        services offered on or through the Website and/or through any mobile
        application(s) ( “Application”) (collectively referred to as the
        “Platform”).
      </h6>
      <h6>
        These Terms of Use apply to end users of the Website (referred to as
        “Learners”, “You”, “Your”). These Terms of Use, including the Privacy
        Policy and any other terms and conditions published on the Platform or
        communicated to you from time to time (collectively referred to as the
        “Agreement”), define the relationship and responsibilities between You
        and Creator (as defined herein) in using the Platform. Your access to
        the Platform is subject to Your acceptance of this Agreement. Hence,
        please take Your time to read this Agreement.
      </h6>
      <h6>
        When we speak of “Creator”, ‘we’, ‘us’, and ‘our’, we collectively mean
        The Financial Ladder being the creator of this Platform and the
      ...
      <br />
      <h5>
        1. <b>Access and Registration:</b>
      </h5>
      <h6>
        <strong>
          <q>Access and Registration:</q>
        </strong>{" "}
        If You’re an individual You must be at least 18 (eighteen) years of age,
        or, if You are between the ages of 13 and 18, You must have Your parent
        or legal guardian's permission to use the Platform. By using the
        Platform, You are, through Your actions, representing and warranting to
        us that You have obtained the appropriate consents/permissions to use
        the Platform. If You are under the age of 13 years or 16 years
        (depending on your country of reisdence), You may neither use our
        Platform in any manner nor may You register for any content or services
        offered therein.
      </h6>
      <h6>
      ...
      <h6>
        For the purpose of this Agreement, “Content” shall mean and include any
        course or session (whether pre-recorded or live) published by the
      ...
      <h6>
        ...
        with us and other registrants to the Content (“Public Forum”).
        Participating in the Public Forum is completely Your choice and by
        registering or enrolling to a Content on the Platform, You are not
        obligated to participate in such Public Forum.
      </h6>
      ...
      <h6>
        ...
        You will need to use a “Supported/Compatible Device” which means a
        personal computer, mobile phone, portable media player, or other
        electronic device that meets the system and compatibility requirements
        and on which You are authorized to operate the Platform. The
        Supported/Compatible Devices to access the Platform may change from time
        to time and, in some cases, whether a device is (or remains) a
      ...
      <h5>
        2. <b>License to Use:</b>
      </h5>
      <h6>
        <strong>
          <q>License to Use:</q>
        </strong>{" "}
        ou are granted a limited, non-exclusive license to access and view the
        Content on the Platform for Your own personal, non-commercial use only.
        Further, if so allowed on the Platform, You may temporarily download one
        copy of any downloadable Content [including Creator Content (defined
        below)] on the Platform for personal and non-commercial transitory
        viewing only.
      </h6>
      ...
      <h5>
        3. <b>Communications:</b>
      </h5>
      <h6>
        <strong>
          <q>Communications:</q>
        </strong>{" "}
        he Platform includes provision and facilitation of Public Forums
        ...
        However, if You choose to participate, You agree to adhere to the terms
        specified in the ‘Code of Conduct’ section hereinbelow and such other
        terms as may be published on our Platform. If it comes to our notice
        that Your conduct is in violation of the terms of this Agreement, then
        we may terminate or suspend Your access to any Public Forums at any
        time, without notice, for any reason. You represent and warrant that You
        own and control all rights in and to any content (including without
        limitation chats, postings, or materials) uploaded or posted by You on
        the Public Forums or anywhere on the Platform (“Learner Content”), or
        that You are licensed to use and reproduce such Learner Content. We are
        not responsible for the information that You choose to share on the
        Public Forums, or for the actions of other users therein. You further
      ...
      <h5>
        4. <b>Code of Conduct:</b> You agree to the following:
      </h5>
      <div className="sub__points">
        <h6>
          a.{" "}
          <strong>
            <q>Legitimate usage of the Platform:</q>
          </strong>{" "}
        ...
        <h6>
          b.{" "}
          <strong>
            <q>No harmful or dangerous content:</q>
          </strong>{" "}
        ...
        <h6>
          c.{" "}
          <strong>
            <q>No hateful or defamatory content:</q>
          </strong>{" "}
        ...
        <h6>
          d.{" "}
          <strong>
            <q>Violent and graphic content:</q>
          </strong>{" "}
        ...
        <h6>
          e.{" "}
          <strong>
            <q>Harassment and bullying:</q>
          </strong>{" "}
          We do not tolerate any form of harassment or bullying on the Platform
          and strive to keep the Platform a safe space to foster learning.
        ...
        <h6>
          ...
          Posting untargeted, unwanted and repetitive content, comments or
          messages with an intention to spam a Public Forum or otherwise the
          Platform and to drive traffic from the Platform to other third-party
          sites is in direct violation of this Agreement. Posting links to
          external websites with malware and other prohibited sites is not
          allowed.
        </h6>
        ...
        <h6>
          ...
          Any content uploaded or posted in order to trick others for their own
          financial gain is not allowed and we do not tolerate any practices of
          extortion or blackmail, either.
        </h6>
        <h6>
          h.{" "}
          <strong>
            <q>Privacy violation:</q>
          </strong>{" "}
          Kindly refer to our Privacy Policy to know how to protect Your privacy
          and respect the privacy of other Users.
        </h6>
        <h6>
          i.{" "}
          <strong>
          ...
          who the real person is by pretending to be them (such as using names,
          image, documents, certificates etc. not belonging to You or not used
          to identify You, or pretending to be a company, institute, group etc.,
          by using their logo, brand name or any distinguishing mark).
        </h6>
        <h6>
          j.{" "}
          <strong>
            <q>Unauthorized Access or Disabling of Platform:</q>
          </strong>{" "}
      ...
      <h6>
        ...
        We own all information and materials, including Content and Creator
        Content (in whatever form or media) provided or communicated to You by
        or on behalf of us including but not limited to, the Platform,
        trademarks, trade dress, logos, wordmarks, illustrations, letters,
        ...
        which is owned by or licensed to us, instructions embedded in any form
        of digital documents and other data, information, or material made
        available to You by us (“Creator’s Intellectual Property”). Creator’s
        Intellectual Property, including the copyrights and trademarks contained
        therein, may not be modified by You in any way. You acknowledge and
        agree that You do not acquire any ownership rights to Creator’s
        Intellectual Property by use of the Platform or any part thereof. You
        acknowledge and agree that the Creator’s Intellectual Property is
        protected by the applicable intellectual property laws, including
        international copyright, trademark, patent, trade secret and other
        intellectual property or proprietary rights laws and any unauthorized
        use, reproduction, modification, distribution, transmission,
        republication, display or performance of the Creator’s Intellectual
        Property or any component thereof is strictly prohibited.
      </h6>
      ...
      <h6>
        ...
        If You submit suggestions, ideas, comments, or questions containing
        product feedback about any Content, the Platform or any part thereof,
        either through the Public Forum or otherwise (“Feedback”), then You
        grants to us a worldwide, non-exclusive, royalty-free, perpetual, and
        irrevocable right to use (and full right to sublicense), reproduce,
        modify, adapt, publish, translate, create derivative works from,
        distribute, transmit, and display such Feedback in any form. You shall
        have no intellectual property right in any Content, Platform or any part
        thereof, as a result of our incorporation of Feedback into any Content
        or the Platform.
      </h6>
      ...
      <h6>
        <strong>
          <q>Payments and Refunds:</q>
        </strong>{" "}
        o register/enrol for any Content, You may need to pay a fee as may be
        ...
        applicable taxes, so we suggest that You read terms and policies of of
        such third party payment processors to understand the same better. Once
        You purchase access to a Content on the Platform, the same cannot be
        cancelled and there shall be no refund of the Content Fee, unless
        otherwise stated in our Refund Policy.
      </h6>

      <h6>
        As stated above, we use third-party service providers to enable You to
        make payment for the purchases made on the Platform. Accordingly, it is
        hereby clarified that we do not capture and/or store any of your
        sensitive personal information. While making payments through such
        third-party payment gateways/service providers kindly ensure to read
        through their terms and conditions.
      </h6>

      <h5>
        8. <b>Payments and Refunds:</b>
      </h5>
      <h6>
        <strong>
          <q>Payments and Refunds:</q>
      ...
      <h6>
        ...
        PERMITTED UNDER APPLICABLE LAW, THE CREATOR, ON ITS OWN BEHALF AND ON
        ...
        IMPLIED, STATUTORY OR OTHERWISE, WITH RESPECT TO THE PLATFORM, INCLUDING
        ...
        WITHOUT LIMITATION TO THE FOREGOING, THE CREATOR PROVIDES NO WARRANTY OR
        UNDERTAKING, AND MAKES NO REPRESENTATION OF ANY KIND THAT THE PLATFORM
        OR THE SERVICES OR PRODUCTS OFFERED THEREIN WILL MEET YOUR REQUIREMENTS,
      ...
      <h5>
        10. <b>PLimitation of Liability:</b>
      </h5>
      <h6>
        <strong>
          <q>Limitation of Liability:</q>
        </strong>{" "}
        In no event shall the Creator be liable for any damages (including,
        ...
        Content or any other materials on the Platform, even if the Creator or
        any authorized personnel of the Creator has been notified orally or in
        ...
        consequential or incidental damages, so, some or all of these
        limitations may not apply to You.
      </h6>

      <h5>
        11. <b>Indemnity and Release:</b>
      </h5>
      <h6>
        <strong>
          <q>Indemnity and Release:</q>
        </strong>{" "}
        You shall indemnify and hold harmless the Creator and where applicable,
        its officers, directors, agents and employees, from any claim or demand,
        or actions including reasonable attorney's fees, made by any third party
        or penalty imposed due to or arising out of Your breach of this
        Agreement or any document incorporated by reference, or Your violation
        of any law, rules, regulations or the rights of a third party.
      </h6>

      <h5>
        12. <b>Links to Third Party Website:</b>
      </h5>
      <h6>
        <strong>
          <q>Links to Third Party Website:</q>
        </strong>{" "}
        Creator has not reviewed all of the sites linked to its Platform and is
        not responsible for the contents of any such linked site. The inclusion
        of any link does not imply endorsement by the Creator of such site. Use
        of any such linked website is at the Your own risk.
      </h6>

      <h5>
        13. <b>Governing Law and Jurisdiction:</b>
      </h5>
      <h6>
        <strong>
          <q>Governing Law and Jurisdiction:</q>
        </strong>{" "}
        Any claim relating to the Platform shall be governed by the laws of the
        Creator’s home jurisdiction (as provided on the Platform) without regard
        to its conflict of law provisions. You agree, as we do, to submit to the
        exclusive jurisdiction of the courts at Creator’s home jurisdiction.
      </h6>
      <h5>
        13. <b>Miscellaneous: </b>
      </h5>
      <div className="sub__points">
        <h6>
          a.{" "}
          <strong>
            <q>Alteration of Platform or Amendments to the Conditions:</q>
          </strong>{" "}
          You agree to use the Platform only for lawful purposes and You are not
          allowed to use our Platform to engage in any kind of activity that
          violates any applicable central, state, local, federal or
        ...
        <h6>
          ...
          You may not assign or transfer this Agreement, by operation or law or
          otherwise. Any attempt by You to assign or transfer this Agreement
        ...
        <h6>
          e.{" "}
          <strong>
            <q>Events beyond our reasonable control:</q>
          </strong>{" "}
      ...
      <h6>
        ...
        write to us by email at contact@thefinancialladder.com.
      </h6>
    </div>
  );
}
